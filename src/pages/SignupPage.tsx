...
import { Eye, EyeOff, Mail, Lock, User, Phone, MapPin, X } from 'lucide-react';
...
const SignupPage: React.FC = () => {
  ...
  const handleSocialSignup = (provider: string) => {
    alert(`${provider} signup will be available soon! For now, please use the form above.`);
  };
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white relative">
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Create an account. It's free</p>
          </div>
